...
static int eCollisionShapeID = 0;
...
void	CcdPhysicsDemo::initPhysics()
{
	...
	for (int i = 0; i < 3; i++)
	{
		...
		ghost->getWorldTransform().setOrigin(btVector3(0, 15, i * -15));
...
void CcdPhysicsDemo::collectContacts(btAlignedObjectArray<btVector3>& positions, btAlignedObjectArray<btVector3>& normals)
{
