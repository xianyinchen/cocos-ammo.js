...
///CompoundShapeDemo is good starting point for learning the code base and porting.

class CompoundShapeDemo : public PlatformDemoApplication
{
	...
	{
		CompoundShapeDemo* demo = new CompoundShapeDemo;
		demo->myinit();
		demo->initPhysics();
		return demo;
	}
